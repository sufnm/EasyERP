...
export default function ExpenseAccountsPage({ setActivePage }) {
  ...
  useEffect(() => {
    ...
    fetch(API_ENDPOINTS.ACCOUNT_CACHE)
      ...
      .then(data => {
        // Filter or modify for Expenses if needed, but the user said "copy same"
    ...
    <div className="flex flex-col h-full p-6 animate-in fade-in zoom-in-95 duration-300">
      <div className="max-w-7xl mx-auto w-full flex flex-col flex-1 h-full relative">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4 px-2">
          <div>
            <h1 className="text-3xl font-black text-zinc-900 dark:text-white tracking-tighter uppercase">Expense Accounts</h1>
            <p className="text-zinc-500 dark:text-zinc-400 text-sm font-medium">Monitor and manage your business expense accounts.</p>
          </div>
          <button 
