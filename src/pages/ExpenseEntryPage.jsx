    ...
    return (
      <div className="flex h-full min-h-[400px] items-center justify-center">
        <div className="flex flex-col items-center gap-4 p-8 bg-white dark:bg-zinc-900 rounded-2xl shadow-xl border border-zinc-200 dark:border-zinc-800 max-w-md text-center transition-colors duration-300">
          ...
          <p className="text-zinc-500 dark:text-zinc-400 font-semibold text-xs mt-1 leading-relaxed">You do not have permission to view Expense Entry. Please contact your system administrator.</p>
          <button 
          ...
          <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl shadow-sm overflow-hidden flex flex-col transition-colors duration-300">
            ...
            <form onSubmit={handleSave} className="p-5 space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-x-5 gap-y-3.5">
                ...
                {/* Payment Settings */}
                <div className="col-span-1 md:col-span-4 grid grid-cols-1 md:grid-cols-2 gap-x-5 gap-y-3.5 p-4 bg-emerald-50/10 dark:bg-emerald-950/5 rounded-2xl border border-emerald-100/50 dark:border-emerald-900/20 transition-colors">
                  <div className="col-span-1 md:col-span-2 flex items-center gap-2">
                    <label className="flex items-center gap-2.5 cursor-pointer group">
                      <input 
                        ...
                        onChange={handleInputChange}
                        className="accent-emerald-500 w-4 h-4 rounded border-zinc-300 focus:ring-emerald-500"
                      />
                      <span className="text-[10px] font-black uppercase tracking-widest text-emerald-600 dark:text-emerald-400 group-hover:text-emerald-700 dark:group-hover:text-emerald-300 transition-colors">Paying Now (Settled directly)</span>
                    </label>
                  </div>

                  <SearchableDropdown
                    label="Paying From (Cash/Bank Account)"
                    name="cashBankAcc"
                    ...
                    className={!formData.payingNow ? 'opacity-40' : ''}
                  />
                </div>
                ...
                {/* VAT Section */}
                <div className="col-span-1 md:col-span-4 grid grid-cols-1 md:grid-cols-2 gap-x-5 gap-y-3.5">
                  
                  {/* VAT Amount */}
                  <div className="space-y-1">
                    <label className="text-[10px] font-black text-zinc-400 dark:text-zinc-500 uppercase tracking-widest block">VAT Amount</label>
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={handleInputChange}
                        className="w-full pl-16 pr-4 py-2 bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-xl text-xs font-semibold text-zinc-850 dark:text-zinc-100 outline-none focus:border-rose-500 focus:ring-4 focus:ring-rose-500/10 transition-all shadow-inner"
                        placeholder="0.00"
                      />
                    </div>
                  </div>
            ...
            <table className={`w-full ${language === 'ar' ? 'text-right' : 'text-left'} border-collapse`}>
              <thead>
                <tr className="bg-zinc-50 dark:bg-zinc-950/50 border-b border-zinc-100 dark:border-zinc-800/80">
                  ...
                  <th className="px-6 py-3 text-[10px] font-black text-zinc-400 dark:text-zinc-500 uppercase tracking-widest">Expense Acc</th>
                  <th className="px-6 py-3 text-[10px] font-black text-zinc-400 dark:text-zinc-500 uppercase tracking-widest">Pay To Acc</th>
