        ...
        <div className="bg-card rounded-xl border border-border shadow-sm overflow-hidden flex flex-col">
          ...
          <form onSubmit={handleSave} className="p-2 space-y-1.5">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-1.5">
              ...
              <div className="space-y-0.5">
                <label className="text-[9px] font-bold text-zinc-500 uppercase tracking-wider">Salary Type</label>
                <div className="relative">
              ...
              <div className="col-span-4 grid grid-cols-2 gap-1.5 p-1.5 bg-zinc-50/50 rounded-lg border border-zinc-100">
                ...
                <div className="space-y-0.5">
                  <label className="text-[9px] font-bold text-zinc-500 uppercase tracking-wider">Employee/Payable Acc (To)</label>
                  <select
                    name="PAY_TO_ACC"
