...
export const API_ENDPOINTS = {
  ...
  SUPPLIER_INFO: (accNo) => `${API_BASE_URL}/api/suppliers/${accNo}/info`,
  ...
  PURCHASE_SAVE: `${API_BASE_URL}/api/purchases/save`,
  PURCHASE_HISTORY: `${API_BASE_URL}/api/purchases/history`,
  PURCHASE_ITEMS: (recNo) => `${API_BASE_URL}/api/purchases/${recNo}/items`,
  PURCHASE_NEXT_INVOICE: `${API_BASE_URL}/api/purchases/next`,
  ...
  EMAIL_SHARE: `${API_BASE_URL}/api/email/share`,
};
